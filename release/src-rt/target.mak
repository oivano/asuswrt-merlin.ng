...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			NANO=y NTPD=y NETOOL=n TRACEROUTE=n
...
DSL-AC68U-NONE := LOGO_LED=y LED_BTN=y ROG=y DNSPRIVACY=y MEDIASRV=y EMAIL=y DWB=y ETHOBD=y PRINTER=y ACCEL_PPTPD=y SMARTSYNCBASE=y CONNDIAG=y \
		  ...
		  HSPOT=y SNMPD=y TOR=y MULTICASTIPTV=y OOKLA=y FILEFLEX=y REPEATER=y NANO=y NEW_USER_LOW_RSSI=y AMAS=y PARENTAL2=y BWDPI=y FRS_FEEDBACK=y FRS_LIVE_UPDATE=y
export DSL-AC68U := $(filter-out $(DSL-AC68U-NONE),$(RT-AC68U_BASE))
export DSL-AC68U += BUILD_NAME="DSL-AC68U" TFAT=y NTFS="tuxera" HFS="tuxera" DSL=y DSL_TCLINUX=y VDSL=y BTN_WPS_ALLLED=y TCPDUMP=n BCM4352_5G=y JFFS_NVRAM=y AHS=y ASD=n FRS_LIVE_UPDATE=n FRS_FEEDBACK=n \
		    MERLINUPDATE=n WIFIPWR=y CONNTRACK=n CFGSYNC=n LIBASUSLOG=y TRACEROUTE=y HTOP=y CLOUDSYNC=n OPENCONNECT=y LLDPD_1_0_11=y \
...
export TUF-AX5400 += UPNPIGD2=n VISUALIZATION=y WIREGUARD=y
...
export TUF-AX3000 += UPNPIGD2=n VISUALIZATION=y IFTT=y LACP=n WIREGUARD=y
