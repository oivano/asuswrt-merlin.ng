...
export DSL-AC68U += BUILD_NAME="DSL-AC68U" TFAT=y NTFS="tuxera" HFS="tuxera" DSL=y DSL_TCLINUX=y VDSL=y BTN_WPS_ALLLED=y TCPDUMP=y BCM4352_5G=y JFFS_NVRAM=y AHS=y ASD=n FRS_LIVE_UPDATE=y \
		    MERLINUPDATE=n WIFIPWR=y CONNTRACK=y CFGSYNC=n LIBASUSLOG=y TCPDUMP=y TRACEROUTE=y CLOUDSYNC=n FRS_FEEDBACK=y
