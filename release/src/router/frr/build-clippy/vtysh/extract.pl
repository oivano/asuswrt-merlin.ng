...
foreach (@ARGV) {
    ...
    open (FH, "gcc -E -DHAVE_CONFIG_H -DVTYSH_EXTRACT_PL -Ivtysh/.. -Ivtysh/../.. -Ivtysh/../../lib -Ivtysh/../lib -Ivtysh/../../bgpd -Ivtysh/../../bgpd/rfapi -I/usr/include/python3.8 -I/usr/local/include/json-c $file |");
    local $/; undef $/;
    $line = <FH>;
    close (FH);
