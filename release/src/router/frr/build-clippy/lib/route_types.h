...
#define FRR_REDIST_STR_BABELD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|bgp|eigrp|nhrp|table|vnc|sharp>"
...
#define FRR_IP_REDIST_STR_BABELD \
  "<kernel|connected|static|rip|ospf|isis|bgp|eigrp|nhrp|table|vnc|sharp>"
...
#define FRR_REDIST_STR_BGPD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|eigrp|nhrp|table|vnc|vnc-direct|babel|sharp>"
...
#define FRR_IP_REDIST_STR_BGPD \
  "<kernel|connected|static|rip|ospf|isis|eigrp|nhrp|table|vnc|vnc-direct|babel|sharp>"
...
#define FRR_REDIST_STR_EIGRPD \
  "<kernel|connected|static|rip|ospf|isis|bgp|nhrp|table|vnc|babel|sharp>"
...
#define FRR_REDIST_STR_ISISD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|bgp|eigrp|nhrp|table|vnc|babel|sharp>"
...
#define FRR_IP_REDIST_STR_ISISD \
  "<kernel|connected|static|rip|ospf|bgp|eigrp|nhrp|table|vnc|babel|sharp>"
...
#define FRR_REDIST_STR_NHRPD \
  "<kernel|connected|static|rip|ripng|ospf|ospf6|isis|bgp|eigrp|table|vnc|babel|sharp>"
...
#define FRR_IP_REDIST_STR_NHRPD \
  "<kernel|connected|static|rip|ospf|isis|bgp|eigrp|table|vnc|babel|sharp>"
...
#define FRR_REDIST_STR_OSPFD \
  "<kernel|connected|static|rip|isis|bgp|eigrp|nhrp|table|vnc|babel|sharp>"
...
#define FRR_REDIST_STR_RIPD \
  "<kernel|connected|static|ospf|isis|bgp|eigrp|nhrp|table|vnc|babel|sharp>"
...
#define FRR_IP_PROTOCOL_MAP_STR_ZEBRA \
  "<kernel|connected|static|rip|ospf|isis|bgp|eigrp|nhrp|table|vnc|babel|sharp|any>"
