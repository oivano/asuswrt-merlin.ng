...
#line 242 "lib/command_parse.c"

#endif /* !YY_CMD_YY_LIB_COMMAND_PARSE_H_INCLUDED  */


/* Unqualified %code blocks.  */
#line 120 "../lib/command_parse.y"
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 174 "../lib/command_parse.y"
{
  // tack on the command element
  terminate_graph (&(yylsp[0]), ctx, ctx->currnode);
}
#line 1590 "lib/command_parse.c"
    break;

  case 3:
#line 179 "../lib/command_parse.y"
{
...
#line 1608 "lib/command_parse.c"
    break;

  case 4:
#line 195 "../lib/command_parse.y"
{
  (yyval.string) = (yyvsp[0].string);
}
#line 1616 "lib/command_parse.c"
    break;

  case 5:
#line 199 "../lib/command_parse.y"
{
  (yyval.string) = NULL;
}
#line 1624 "lib/command_parse.c"
    break;

  case 8:
#line 211 "../lib/command_parse.y"
{
...
#line 1653 "lib/command_parse.c"
    break;

  case 13:
#line 238 "../lib/command_parse.y"
{
...
#line 1718 "lib/command_parse.c"
    break;

  case 19:
#line 279 "../lib/command_parse.y"
{
  (yyval.node) = new_token_node (ctx, MAC_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1727 "lib/command_parse.c"
    break;

  case 20:
#line 284 "../lib/command_parse.y"
{
  (yyval.node) = new_token_node (ctx, MAC_PREFIX_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1736 "lib/command_parse.c"
    break;

  case 21:
#line 291 "../lib/command_parse.y"
{
  struct cmd_token *token = (yyval.node)->data;
...
#line 1781 "lib/command_parse.c"
    break;

  case 25:
#line 328 "../lib/command_parse.y"
{
  (yyval.subgraph) = (yyvsp[-2].subgraph);
...
#line 1799 "lib/command_parse.c"
    break;

  case 26:
#line 345 "../lib/command_parse.y"
{
  (yyval.subgraph).start = (yyval.subgraph).end = (yyvsp[0].node);
}
#line 1807 "lib/command_parse.c"
    break;

  case 28:
#line 353 "../lib/command_parse.y"
{
...
#line 1817 "lib/command_parse.c"
    break;

  case 30:
#line 363 "../lib/command_parse.y"
{
  (yyval.subgraph) = (yyvsp[-2].subgraph);
