...
#ifndef EVENT_RPCOUT_______LIBEVENT_TEST_REGRESS_RPC_
#define EVENT_RPCOUT_______LIBEVENT_TEST_REGRESS_RPC_
...
#endif  /* EVENT_RPCOUT_______LIBEVENT_TEST_REGRESS_RPC_ */