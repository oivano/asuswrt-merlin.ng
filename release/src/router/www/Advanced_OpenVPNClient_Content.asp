		...
		<div class="formfontdesc">
				...
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
					...
					<tr id="client_username">
						<th>Username</th>
						<td>
							<input type="text" maxlength="64" class="input_25_table" name="vpn_client_username" value="<% nvram_clean_get("vpn_client_username"); %>" autocomplete="username" autocorrect="off" autocapitalize="off" spellcheck="false">
						</td>
					</tr>
