...
<head>
	...
	<title>
		<#Web_Title#> - OpenConnect VPN Client
	</title>
	...
	<script>
		...
		function initial() {
			...
			if (openvpnd_support || vpnc_support || ipsec_cli_support) {
...
<body onload="initial();" onunLoad="return unload_body();" class="bg">
								...
								<td valign="top">
									<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0"
										...
										<tr>
											...
											<td>
												<textarea rows="8" class="textarea_ssh_table" spellcheck="false"
													id="openconnect_client_ca_textarea" cols="65"
										...
										<tr>
											...
											<td>
												<textarea rows="8" class="textarea_ssh_table" spellcheck="false"
													id="openconnect_client_cert_textarea" cols="65"
													maxlength="8000"></textarea>
											</td>
										</tr>
										<tr>
											...
											<td>
												<textarea rows="8" class="textarea_ssh_table" spellcheck="false"
													id="openconnect_client_key_textarea" cols="65"
													maxlength="8000"></textarea>
											</td>
										</tr>
									</table>
	...
	<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
		...
		<input type="hidden" name="openconnect_client1_enable" value="<% nvram_get(" openconnect_client1_enable"); %>"
		disabled>
		<input type="hidden" name="openconnect_client1_server" value="<% nvram_get(" openconnect_client1_server"); %>"
		disabled>
		<input type="hidden" name="openconnect_client1_port" value="<% nvram_get(" openconnect_client1_port"); %>"
		disabled>
		<input type="hidden" name="openconnect_client1_protocol" value="<% nvram_get(" openconnect_client1_protocol");
			%>" disabled>
		<input type="hidden" name="openconnect_client1_username" value="<% nvram_get(" openconnect_client1_username");
			%>" disabled>
		<input type="hidden" name="openconnect_client1_password" value="<% nvram_get(" openconnect_client1_password");
			%>" disabled>
		<input type="hidden" name="openconnect_client1_authgroup" value="<% nvram_get(" openconnect_client1_authgroup");
			%>" disabled>
		<input type="hidden" name="openconnect_client1_interface" value="<% nvram_get(" openconnect_client1_interface");
			%>" disabled>
		<input type="hidden" name="openconnect_client1_disable_ipv6" value="<% nvram_get("
			openconnect_client1_disable_ipv6"); %>" disabled>
		<input type="hidden" name="openconnect_client1_reconnect_timeout" value="<% nvram_get("
			openconnect_client1_reconnect_timeout"); %>" disabled>
		<input type="hidden" name="openconnect_client1_background" value="<% nvram_get("
			openconnect_client1_background"); %>" disabled>
		...
		<input type="hidden" name="openconnect_client2_enable" value="<% nvram_get(" openconnect_client2_enable"); %>"
		disabled>
		<input type="hidden" name="openconnect_client2_server" value="<% nvram_get(" openconnect_client2_server"); %>"
		disabled>
		<input type="hidden" name="openconnect_client2_port" value="<% nvram_get(" openconnect_client2_port"); %>"
		disabled>
		<input type="hidden" name="openconnect_client2_protocol" value="<% nvram_get(" openconnect_client2_protocol");
			%>" disabled>
		<input type="hidden" name="openconnect_client2_username" value="<% nvram_get(" openconnect_client2_username");
			%>" disabled>
		<input type="hidden" name="openconnect_client2_password" value="<% nvram_get(" openconnect_client2_password");
			%>" disabled>
		<input type="hidden" name="openconnect_client2_authgroup" value="<% nvram_get(" openconnect_client2_authgroup");
			%>" disabled>
		<input type="hidden" name="openconnect_client2_interface" value="<% nvram_get(" openconnect_client2_interface");
			%>" disabled>
		<input type="hidden" name="openconnect_client2_disable_ipv6" value="<% nvram_get("
			openconnect_client2_disable_ipv6"); %>" disabled>
		<input type="hidden" name="openconnect_client2_reconnect_timeout" value="<% nvram_get("
			openconnect_client2_reconnect_timeout"); %>" disabled>
		<input type="hidden" name="openconnect_client2_background" value="<% nvram_get("
			openconnect_client2_background"); %>" disabled>
										...
										<tr bgcolor="#4D595D">
											<td valign="top">
												...
												<div class="formfontdesc">
													OpenConnect is a VPN client supporting multiple enterprise VPN
													protocols including Cisco AnyConnect,
													Juniper Network Connect, Pulse Secure, Palo Alto GlobalProtect, F5
													Big-IP, and Fortinet.
												</div>
												...
												<table width="100%" border="1" align="center" cellpadding="4"
													...
													<tr>
														<th>Select Client</th>
														<td>
															<select name="client_unit_select" class="input_option"
																onchange="switch_openconnect_unit(this.value);">
												...
												<table width="100%" border="1" align="center" cellpadding="4"
													...
													<tr>
														...
														<td>
															<div class="left"
																...
																id="radio_openconnect_enable"></div>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<input type="radio" name="openconnect_client_x_eas"
																class="input" value="1">
															<#checkbox_Yes#>
																<input type="radio" name="openconnect_client_x_eas"
																	class="input" value="0" checked>
																<#checkbox_No#>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="255" class="input_32_table"
																name="openconnect_client_server" value="">
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="5" class="input_6_table"
																name="openconnect_client_port" value="">
													...
													<tr>
														...
														<td>
															<select name="openconnect_client_protocol"
																id="openconnect_client_protocol" class="input_option"
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="64" class="input_25_table"
																name="openconnect_client_username" value=""
													...
													<tr>
														...
														<td>
															<input type="password" maxlength="64" class="input_25_table"
																name="openconnect_client_password" value=""
																autocomplete="off">
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="64" class="input_25_table"
																name="openconnect_client_authgroup" value="">
															<div><span>Group name for authentication (optional)</span>
															</div>
														</td>
													</tr>
												</table>
												...
												<table width="100%" border="1" align="center" cellpadding="4"
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="15" class="input_15_table"
																name="openconnect_client_interface" value="">
													...
													<tr>
														...
														<td>
															<select name="openconnect_client_disable_ipv6"
																class="input_option">
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="5" class="input_6_table"
																name="openconnect_client_reconnect_timeout" value="">
													...
													<tr>
														...
														<td>
															<select name="openconnect_client_background"
																class="input_option">
																<option value="0">No</option>
													...
													<tr>
														...
														<td>
															<input type="button" class="button_gen"
																value="Edit Certificates" onclick="show_cert_panel();">
														</td>
													</tr>
												</table>
