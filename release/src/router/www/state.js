...
var dnscrypt_support = isSupport("dnscrypt");
...
var ParentalCtrl2_support = false;
...
function show_banner(L3) {// L3 = The third Level of Menu
	...
	if (rog_support) {
		...
		banner_code += '<div style="margin-left:25px;width:160px;height:52px;margin-top:0px;float:left;" align="left"><span><a href="https://oivano.github.io/asuswrt-merlin.ng/" target="_blank" rel="noreferrer"></a></span></div>';
...
function showMenuTree(menuList, menuExclude) {
	...
	var getCode = function (flag) {
		var getMenuCode = function () {
			...
			if (rog_support)
				menu_code += '<div style="width:160px;height:52px;"><span><a href="https://oivano.github.io/asuswrt-merlin.ng/" target="_blank" rel="noreferrer"></a></span></div>';
	...
	// On DSL models, VDSL content shares the same WAN tab identity as DSL content.
	var menu_match_url = current_url;
	if (dsl_support && current_url === "Advanced_VDSL_Content.asp") {
		menu_match_url = "Advanced_DSL_Content.asp";
	}
	...
	for (var i = 0; i < menuList.length; i++) {
		...
		for (var j = 0; j < curMenu.tab.length; j++) {
			if (menu_match_url === curMenu.tab[j].url) {
				clickedItem.menu = i;
