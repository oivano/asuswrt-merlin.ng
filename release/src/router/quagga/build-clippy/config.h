...
/* bfdd control socket */
#define BFDD_CONTROL_SOCKET "/var/run%s%s/bfdd.sock"
...
#define DAEMON_DB_DIR "/var/run"

/* daemon vty directory */
#define DAEMON_VTY_DIR "/var/run%s%s"
...
/* ldpd control socket */
#define LDPD_SOCKET "/var/run%s%s/ldpd.sock"
...
#define OSPFD_GR_STATE "/var/run%s/ospfd-gr.json"
...
/* path to scripts */
#define SCRIPT_PATH "/usr/local/etc/scripts"
...
/* zebra api socket */
#define ZEBRA_SERV_PATH "/var/run%s%s/zserv.api"
